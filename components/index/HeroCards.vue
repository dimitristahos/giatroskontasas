        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10 border-b border-neutral-900 pb-8">
            <div class="rounded-xl bg-white mt-[-60px] lg:mt-[-120px]">
                <div class="p-5">
                    ...
                    <p class="text-gray-600 text-lg max-w-[550px]">
                        Ιδανικό για βασικές ιατρικές ανάγκες στο σπίτι, όπως έλεγχος ζωτικών σημείων, συνταγογράφηση και
                        απλές θεραπείες.
                    </p>
                </div>
            ...
            <div class="rounded-xl bg-white mt-5 lg:mt-[-120px]">
                <div class="p-5">
                    ...
                    <p class="text-gray-600 text-lg max-w-[550px]">
                        Εξειδικευμένη φροντίδα με τακτικές επισκέψεις, διαχείριση χρόνιων παθήσεων και εξατομικευμένες
                        ιατρικές συμβουλές.
                    </p>
                </div>
